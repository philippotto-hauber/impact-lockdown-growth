...
df_plot$status[df_plot$country == "Germany"] <- "Deutschland"
       ggplot(df_plot, aes(x = value, y = gdpH1))+
         geom_point()+
         geom_text(data = filter(df_R2, var %in% c("Lockdown-Stringenz", "Offenheit", "Tourismus (WTTC)", "Tourismus (Weltbank)", "Covid-19-Infektionen", "Covid-19-Todesfälle", "Wirtschaftsstruktur", "Mobilitätsdaten")),
...
```{r}
subset_indicators <- c("Covid-19-Todesfälle", "Offenheit", "Wirtschaftsstruktur", "Lockdown-Stringenz")
```
