...
```{r}
df %>% select(-c(dev_gdp)) %>% 
       filter(var %in% c("stringency", "openness", "tourism", "covid19deaths"),
              country != "China") %>% 
       ...
       ggplot(aes(x = value, y = gdpH1))+
         ...
         labs(y = "BIP, Prozent", x = "",
              ...
              caption = paste0("Daten für ", length(unique(df$country)) - 1 , " Länder, BIP: Veränderung zwischen 2020Q2 und 2019Q4, Todesfälle: kumuliert, je 1 Mio. Einwohner, Stand 30.6.2020,\nOffenheit: Summe der Exporte und Importe im Verhältnis zur Wirtschaftsleistung,Tourismus: Einnahmen im Verhältnis zur Wirtschaftsleistung,\nLockdown-Stringenz: Index, Durchschnitt in 2020H1, höhere Werte = strengere Maßnahmen, schwarze Linie: linearer Trend.\nQuelle: OECD Main Economic Indicators, Deutsche Bundesbank, ECDC, IMF International Financial Statistics,\nHale et al. (2020), Weltbank World Development Indicators."))+
        theme_minimal()+
